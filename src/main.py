...
- 각 이슈를 뒷받침하는 메시지 1~2개를 골라 해당 괄호 속 URL을 사용해 Slack 하이퍼링크 형식으로 기입한다.
- 형식: <URL|메시지1>, <URL|메시지2>
  예시: <https://discord.com/channels/1374314257096900640/1234567890/9876543210|메시지1>, <https://discord.com/channels/1374314257096900640/1234567890/1111111111|메시지2>
